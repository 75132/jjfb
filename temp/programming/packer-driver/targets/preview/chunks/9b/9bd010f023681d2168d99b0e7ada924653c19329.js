    ...
    execute: function () {
      ...
      _export("WebSocketManager", WebSocketManager = (_dec = ccclass('WebSocketManager'), _dec(_class = (_class2 = class WebSocketManager extends Component {
        ...
        request(route, data, callback, requireAuth, timeout) {
          ...
          var RETRY_ON_TIMEOUT_ROUTES = new Set(['bag_get', 'get_robot_pets', 'get_character_info', 'get_player', 'get_chat_history', 'get_announcements_history', 'battle_room_resume', 'world_enter']); // 生成 request_id（如果消息中没有）
          ...
          try {
            ...
            if (data && data.type) {
              ...
              if (data.type === 'login_response' || data.type === 'register_response') {
                ...
                var ok = (payload == null ? void 0 : payload.success) === true || (payload == null ? void 0 : payload.success) === 1 || (payload == null ? void 0 : payload.success) === 'true';
...
//# sourceMappingURL=9bd010f023681d2168d99b0e7ada924653c19329.js.map