      ...
      _export("BattleScene", BattleScene = (_dec = ccclass('BattleScene'), _dec2 = property({
        ...
        constructor() {
          ...
          this.onRobotPetsResponseForBattle = data => {
            ...
            var pets = this._extractPetsFromCache(data);
        ...
        onLoad() {
          ...
          } catch (_unused) {} // 自动恢复由 BattleResumeController 统一负责（本组件只注册自身供恢复打开面板）
        ...
        onEnable() {
          ...
          var intent = (_this$_entryIntent = this._entryIntent) != null ? _this$_entryIntent : 'new-pve';
          var action = (_crd && resolveOnEnableAction === void 0 ? (_reportPossibleCrUseOfresolveOnEnableAction({
            error: Error()
        ...
        startStoryBattle(opts) {
          ...
          var validated = (_crd && validateStoryBattleCreate === void 0 ? (_reportPossibleCrUseOfvalidateStoryBattleCreate({
            error: Error()
        ...
        restoreFromServerState(state) {
          ...
          var characterId = (_this$ws$getCharacter5 = (_this$ws5 = this.ws) == null || _this$ws5.getCharacterId == null ? void 0 : _this$ws5.getCharacterId()) != null ? _this$ws$getCharacter5 : null;
          var validated = (_crd && validateBattleRestoreState === void 0 ? (_reportPossibleCrUseOfvalidateBattleRestoreState({
            error: Error()
          ...
          var prevRoomId = this.roomId;
          var prevApplied = this._appliedRestoreRoomId;
          var prevIntent = this._entryIntent;
        ...
        applyServerRoomState(state, isNewRoom, forRoundAnimation) {
          ...
          if (!state) return;
          var incomingRoomId = (_crd && roomIdOf === void 0 ? (_reportPossibleCrUseOfroomIdOf({
            error: Error()
          ...
          if (!forRoundAnimation) {
            var enemyCid = enemyActor != null && enemyActor.character_id ? String(enemyActor.character_id) : null;
        ...
        checkAndStartBattle() {
          ...
          var characterId = (_this$ws$getCharacter6 = (_this$ws6 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter6.call(_this$ws6);
        ...
        requestRobotPetsAndStart() {
          ...
          var characterId = (_this$ws$getCharacter7 = (_this$ws7 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter7.call(_this$ws7);
        ...
        _extractPetsFromCache(raw) {
          var data = raw != null && raw.data && typeof raw.data === 'object' ? raw.data : raw;
        ...
        _pickBattlePet(pets, battleTeam) {
          ...
          var norm = id => this._normPetId(id);

          if (battleTeam.length > 0) {
            var bid = battleTeam[0];
            var matched = pets.find(p => norm(String(p.pet_id || p._id || p.id || '')) === norm(bid));

            if (matched) {
              var _petId = String(matched.pet_id || matched._id || matched.id || '');
        ...
        initPlayerUnit() {
          ...
          var characterId = (_this$ws$getCharacter8 = (_this$ws8 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter8.call(_this$ws8);
          ...
          var pets = this._extractPetsFromCache(listCache);
          ...
          var cachedTeam = this._battleTeamFromCache(listCache);

          var sessionId = this._sessionId;

          var finishPick = battleTeam => {
            var _this$node8;

            if (!((_this$node8 = this.node) != null && _this$node8.isValid) || this._sessionId !== sessionId) return;

            var picked = this._pickBattlePet(pets, battleTeam);
        ...
        initPlayerUnitWithFallback() {
          ...
          var characterId = (_this$ws$getCharacter9 = (_this$ws9 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter9.call(_this$ws9);
          ...
          var picked = this._pickBattlePet(pets, cachedTeam);
        ...
        finishBattle(winner, reason) {
          ...
          try {
            ...
            var cid = (_this$ws$getCharacter11 = (_this$ws11 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter11.call(_this$ws11);
            ...
            if (cid) {
              ...
              var uid = (_this$ws$getUserId = (_this$ws12 = this.ws).getUserId) == null ? void 0 : _this$ws$getUserId.call(_this$ws12);
        ...
        refreshPlayerShowFromServer() {
          ...
          var characterId = (_this$ws$getCharacter12 = (_this$ws13 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter12.call(_this$ws13);
          ...
          var userId = (_this$ws$getUserId2 = (_this$ws14 = this.ws).getUserId) == null ? void 0 : _this$ws$getUserId2.call(_this$ws14);
        ...
        refreshEnemyShowFromCharacterId(characterId) {
          ...
          var requestId = "battle_get_enemy_" + Date.now() + "_" + Math.floor(Math.random() * 100000);
          var req = {
            character_id: characterId,
            request_id: requestId
          };
          var userId = (_this$ws$getUserId3 = (_this$ws15 = this.ws).getUserId) == null ? void 0 : _this$ws$getUserId3.call(_this$ws15);
          ...
          var cleanup = () => this.clearEnemyInfoListener();
