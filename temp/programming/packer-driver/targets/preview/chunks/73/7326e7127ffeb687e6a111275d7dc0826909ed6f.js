      ...
      _export("BagItem", BagItem = (_dec = ccclass('BagItem'), _dec2 = property(Node), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Button), _dec11 = property(Button), _dec12 = property(EditBox), _dec13 = property(Button), _dec14 = property(Button), _dec15 = property(Label), _dec16 = property(SpriteAtlas), _dec17 = property(SpriteAtlas), _dec18 = property(Node), _dec19 = property(Node), _dec20 = property(Button), _dec21 = property(Button), _dec22 = property(Button), _dec23 = property(_crd && RobotList === void 0 ? (_reportPossibleCrUseOfRobotList({
        ...
        constructor() {
          ...
          this.onUseItemResponse = data => {
            ...
            var targetType = responseData.target_type || 'Unknown';
        ...
        requestWriteRandom() {
          ...
          var cid = ((_this$ws$getCharacter = (_this$ws = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter.call(_this$ws)) || undefined; // 如果有输入框，就读取玩家输入的数量
        ...
        requestFetchBag() {
          ...
          var cid = ((_this$ws$getCharacter2 = (_this$ws2 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter2.call(_this$ws2)) || undefined;
        ...
        render() {
          ...
          var container = this.bagRoot || this.cellTemplate.parent; // 清除所有节点的选中效果（重要：在复用节点前清除，避免选中效果残留）
          ...
          var originY = base.position.y; // 注意：this.items 已经是服务器按分类和分页过滤后的数据，不需要再次过滤
          // 直接使用 this.items 作为 list

          var list = this.items; // 确保节点池里至少有 list.length 个格子
          // 第 0 个永远是模板本身
          ...
          for (var i = this.dynamicNodes.length; i < list.length; i++) {
          ...
          for (var _i = 0; _i < list.length; _i++) {
            var item = list[_i];
            var _node2 = this.dynamicNodes[_i]; // 确保节点激活前清除所有选中效果（防止复用节点时残留）

            this.applyYellowFilter(_node2, false);
            _node2.active = true;
            var col = _i % this.COLS;
            var row = Math.floor(_i / this.COLS);
            var x = originX + col * (cellW + this.GAP);
            var y = originY - row * (cellH + this.GAP);

            _node2.setPosition(x, y);

            this.applyItemIcon(_node2, item.item_id);
            ...
            var itemIndexInCurrentPage = _i; // 当前页内的索引（0-based）

            this.bindItemEvents(_node2, item.item_id, itemIndexInCurrentPage);
          } // 多余的节点隐藏掉，不销毁，下次复用，减少 GC 压力


          for (var _i2 = list.length; _i2 < this.dynamicNodes.length; _i2++) {
            var _node3 = this.dynamicNodes[_i2];
        ...
        applyYellowFilter(node, apply) {
          ...
          if (apply) {
            ...
            if (!filterNode) {
              ...
              var baseSprite = node.getComponent(Sprite);
              var btn = node.getComponent(Button);
              ...
              var sprite = filterNode.addComponent(Sprite); // 优先使用Button的normalSprite（原始图标，不会因为按下而改变）
        ...
        useItemForPlayer(itemId, itemData) {
          ...
          var cid = ((_this$ws$getCharacter3 = (_this$ws3 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter3.call(_this$ws3)) || undefined;
        ...
        confirmUseItemForPet(itemId, petId, petData) {
          ...
          var cid = ((_this$ws$getCharacter4 = (_this$ws4 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter4.call(_this$ws4)) || undefined;
        ...
        onDiscardItem(itemId) {
          ...
          var cid = ((_this$ws$getCharacter5 = (_this$ws5 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter5.call(_this$ws5)) || undefined;
