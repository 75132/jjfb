System.register(["cc"], function (_export, _context) {
  ...
  function shouldCompleteChoice(opt, ev) {
    ...
    var allowed = ev == null || (_ev$server = ev.server) == null ? void 0 : _ev$server.allowedChoiceIds;
  ...
  function isBattleInteractAction(payload, ev) {
    var action = (payload == null ? void 0 : payload.action) || ev.eventType;
  ...
  function promisifyWsRequest(request, route, payload, timeoutMs) {
    if (timeoutMs === void 0) {
      timeoutMs = 8000;
    }
