    ...
    execute: function () {
      ...
      _export("GameMenu", GameMenu = (_dec = ccclass('GameMenu'), _dec2 = property({
        ...
        bindButtonEvents() {
          ...
          this.buttons.forEach((button, index) => {
            if (button && this.panels[index]) {
              var panelName = this.panels[index].name;
        ...
        openPanel(panelName) {
          ...
          var robotList = panel.getComponent(_crd && RobotList === void 0 ? (_reportPossibleCrUseOfRobotList({
            error: Error()
          }), RobotList) : RobotList);
...
//# sourceMappingURL=a171e1752e30c6131fcde51327e89773562275d0.js.map