  ...
  return {
    ...
    execute: function () {
      ...
      _export("PlayerGridMove", PlayerGridMove = (_dec = ccclass('PlayerGridMove'), _dec2 = property({
        ...
        isLikelyUninitializedPosition(x, y) {
          return Number.isFinite(x) && Number.isFinite(y) && Math.abs(x) < 0.5 && Math.abs(y) < 0.5;
        }

        getFallbackSpawn() {
          return {
            x: this.fallbackSpawnX,
            y: this.fallbackSpawnY
          };
        }
...
//# sourceMappingURL=a3af276b689e0a7a19295abefa5a311dc0f472ae.js.map