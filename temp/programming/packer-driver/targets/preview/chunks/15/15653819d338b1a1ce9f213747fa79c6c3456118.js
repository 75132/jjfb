  ...
  return {
    ...
    execute: function () {
      ...
      _export("RobotList", RobotList = (_dec = ccclass('RobotList'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(ScrollView), _dec7 = property(Node), _dec8 = property({
        ...
        type: SpriteFrame
      }), _dec(_class = (_class2 = class RobotList extends Component {
        constructor() {
          super(...arguments);
        ...
        onDestroy() {
          var _this$backButton, _backBtn$node, _this$confirmButton, _confirmBtn$node;

          this.unsubscribeMessages(); // 修复点：解绑 back/confirm 按钮，避免节点销毁后仍触发或内存泄漏

          var backBtn = (_this$backButton = this.backButton) == null ? void 0 : _this$backButton.getComponent(Button);

          if (backBtn && (_backBtn$node = backBtn.node) != null && _backBtn$node.isValid) {
            backBtn.node.off(Button.EventType.CLICK, this.onBack, this);
          }

          var confirmBtn = (_this$confirmButton = this.confirmButton) == null ? void 0 : _this$confirmButton.getComponent(Button);

          if (confirmBtn && (_confirmBtn$node = confirmBtn.node) != null && _confirmBtn$node.isValid) {
        ...
        onEnable() {
          ...
          if ((_this$node = this.node) != null && _this$node.active && this.currentPets.length === 0 && !this.isLoading) {
        ...
        onBattleTeamUpdate(data) {
          var _ref, _data$battle_team, _data$data, _this$node2;
          ...
          if ((_this$node2 = this.node) != null && _this$node2.active && this.currentPets.length > 0) this.refreshListUI();
        }
        ...
        tryRenderIfReady() {
          ...
          if (!this._battleTeamReceived || !this._petsReceived || !((_this$node3 = this.node) != null && _this$node3.active)) return;
        ...
        loadBattleTeamThenPets(useCacheIfAvailable) {
          ...
          var hasFullCache = useCacheIfAvailable && (cachedData == null ? void 0 : cachedData.pets) && Array.isArray(cachedData.pets) && cachedData.pets.length > 0 && cachedData.battle_team && Array.isArray(cachedData.battle_team);
          ...
          } // 并行请求：不等待 GET_BATTLE_TEAM，和 GET_ROBOT_PETS 一起发，首屏等两者齐再渲染
        ...
        requestPets() {
          ...
          if (uid) req.user_id = uid; // 使用 notify + 全局监听（服务器返回 robot_pets_response）
          // 关键修复：不使用缓存，确保数据实时

          this.ws.notify((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            error: Error()
          }), GameConfig) : GameConfig).MESSAGE_TYPES.GET_ROBOT_PETS, req, true);
        }

        onPetsResponse(data) {
          var _data$data2, _data$pagination, _data$data3, _pagination$page;
          ...
          if (!ok) {
            ...
            this._petsReceived = true;
            this.isLoading = false;
            if ((_this$node4 = this.node) != null && _this$node4.active) this.renderList([]);
            return;
          }

          var pets = [];
          if (Array.isArray(data.pets)) pets = data.pets;else if (data != null && (_data$data2 = data.data) != null && _data$data2.pets) pets = data.data.pets;
          var pagination = (_data$pagination = data.pagination) != null ? _data$pagination : (_data$data3 = data.data) == null ? void 0 : _data$data3.pagination;
          ...
          if (page === 0) {
            ...
            var cid = (_this$ws = this.ws) == null ? void 0 : _this$ws.getCharacterId();
        ...
        sortByBattleTeam() {
          ...
          var _loop = function _loop() {
            ...
            var id = _this.normPetId(String((_ref2 = (_ref3 = (_p$pet_id = p.pet_id) != null ? _p$pet_id : p._id) != null ? _ref3 : p.id) != null ? _ref2 : ''));
        ...
        refreshListUI() {
          // 关键修复：先排序，确保出战机甲在前
          this.sortByBattleTeam(); // 关键修复：清空颜色映射，强制重新应用滤镜

          this.bgColorMap.clear(); // 关键修复：重新渲染列表，确保排序和滤镜正确应用
        ...
        fillRow(node, pet, _index) {
          var _ref4, _ref5, _pet$pet_id, _ref6, _pet$Form, _pet$Level, _pet$Class;

          var id = String((_ref4 = (_ref5 = (_pet$pet_id = pet.pet_id) != null ? _pet$pet_id : pet._id) != null ? _ref5 : pet.id) != null ? _ref4 : '');
          var form = Number((_ref6 = (_pet$Form = pet.Form) != null ? _pet$Form : pet.Fo) != null ? _ref6 : 0);
        ...
        updateRowBattleFilter(node, pet) {
          var _ref7, _ref8, _pet$pet_id2, _bg$getComponent2;

          // 关键修复：如果当前行被选中，不覆盖选中效果（黄色优先）
          if (this.selectedNode === node) return;
          var id = this.normPetId(String((_ref7 = (_ref8 = (_pet$pet_id2 = pet.pet_id) != null ? _pet$pet_id2 : pet._id) != null ? _ref8 : pet.id) != null ? _ref7 : ''));
        ...
        bindSetAndActions(node, pet, index) {
          ...
          var petId = String((_ref9 = (_ref10 = (_pet$pet_id3 = pet.pet_id) != null ? _pet$pet_id3 : pet._id) != null ? _ref10 : pet.id) != null ? _ref9 : ''); // 将 pet 数据绑定到节点，方便后续使用
          ...
          if (setBtn) {
            ...
            setBtn.node.off(Button.EventType.CLICK);
          ...
          if (maskN) {
            maskN.off(Node.EventType.TOUCH_END);
        ...
        onDeploy(petId, row, panel) {
          ...
          if (nodePet) {
            var _ref11, _ref12, _nodePet$pet_id;

            // 从 pet 数据中获取正确的 pet_id（服务器返回的 pet_id 对应数据库的 _id）
            var correctId = String((_ref11 = (_ref12 = (_nodePet$pet_id = nodePet.pet_id) != null ? _nodePet$pet_id : nodePet._id) != null ? _ref12 : nodePet.id) != null ? _ref11 : '');
        ...
        submitBattleTeam(team) {
          ...
          if (team.length === 0) {
            this.ws.request((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
              error: Error()
            }), GameConfig) : GameConfig).MESSAGE_TYPES.SET_BATTLE_TEAM, {
              character_id: cid,
              battle_team: []
            }, r => {
              this._submittingBattleTeam = false;
          ...
          var _loop2 = function _loop2() {
            ...
            var pet = _this2.currentPets.find(p => {
              var _ref17, _ref18, _p$pet_id4;

              var pid = _this2.normPetId(String((_ref17 = (_ref18 = (_p$pet_id4 = p.pet_id) != null ? _p$pet_id4 : p._id) != null ? _ref18 : p.id) != null ? _ref17 : ''));
          ...
          var validPets = normalizedTeam.filter(pid => {
            ...
            var pet = this.currentPets.find(p => {
              var _ref13, _ref14, _p$pet_id2;

              return this.normPetId(String((_ref13 = (_ref14 = (_p$pet_id2 = p.pet_id) != null ? _p$pet_id2 : p._id) != null ? _ref14 : p.id) != null ? _ref13 : '')) === pn;
            });
          ...
          console.log('[RobotList] 当前机甲列表 petIds:', this.currentPets.map(p => {
            var _ref15, _ref16, _p$pet_id3;

            return String((_ref15 = (_ref16 = (_p$pet_id3 = p.pet_id) != null ? _p$pet_id3 : p._id) != null ? _ref16 : p.id) != null ? _ref15 : '');
          }));
          this.ws.request((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            error: Error()
          }), GameConfig) : GameConfig).MESSAGE_TYPES.SET_BATTLE_TEAM, {
            ...
            var _r$data$battle_team, _r$data;
        ...
        releasePet(petId) {
          ...
          this.ws.request('admin_delete_robot_pet', {
            pet_id: petId
          }, r => {
            var _r$message3;
            ...
            this._releasing = false;
            this.setDeployReleaseButtonsInteractable(true);
            if (r != null && r.success) this.forceRefresh();else console.error('[RobotList] 放生失败:', (_r$message3 = r == null ? void 0 : r.message) != null ? _r$message3 : '未知错误');
          }, true, 10000);
        }
        ...
        onConfirm() {
          var _ref19, _ref20, _this$selectedPet$pet;

          if (this._confirming) return;
          if (this.selectedIndex < 0 || !this.selectedPet) return;
          var petId = String((_ref19 = (_ref20 = (_this$selectedPet$pet = this.selectedPet.pet_id) != null ? _this$selectedPet$pet : this.selectedPet._id) != null ? _ref20 : this.selectedPet.id) != null ? _ref19 : '');
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "backButton", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
...
//# sourceMappingURL=15653819d338b1a1ce9f213747fa79c6c3456118.js.map