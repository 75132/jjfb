    ...
    execute: function () {
      ...
      _export("StoryUIViewController", StoryUIViewController = (_dec = ccclass('StoryUIViewController'), _dec2 = property({
        ...
        ensureRefs() {
          ...
          const vr = (_this$viewRefs = this.viewRefs) != null ? _this$viewRefs : this.getComponent(_crd && StoryUIViewRefs === void 0 ? (_reportPossibleCrUseOfStoryUIViewRefs({
            error: Error()
          }), StoryUIViewRefs) : StoryUIViewRefs);
          this.viewRefs = vr;
          ...
          const dlg = this._dialoguePanel;
          const spkNode = (_vr$dialogueSpeakerLa = vr == null ? void 0 : vr.dialogueSpeakerLabel) != null ? _vr$dialogueSpeakerLa : childByPath(dlg, ['SpeakerNameLabel']);
          const bodyNode = (_vr$dialogueTextLabel = vr == null ? void 0 : vr.dialogueTextLabel) != null ? _vr$dialogueTextLabel : childByPath(dlg, ['LinesContainer', 'Text']);
          ...
          const nextNd = (_vr$nextButton = vr == null ? void 0 : vr.nextButton) != null ? _vr$nextButton : childByPath(dlg, ['NextBtn']);
          this._nextBtn = (_nextNd$getComponent = nextNd == null ? void 0 : nextNd.getComponent(Button)) != null ? _nextNd$getComponent : null;
          const closeNd = childByPath(dlg, ['CloseBtn']);
          ...
          const cm = this._choiceModal;
          const titleNd = (_vr$choiceTitleLabel = vr == null ? void 0 : vr.choiceTitleLabel) != null ? _vr$choiceTitleLabel : childByPath(cm, ['TitleLabel']);
          this._choiceTitle = (_titleNd$getComponent = titleNd == null ? void 0 : titleNd.getComponent(Label)) != null ? _titleNd$getComponent : null;
          const optRoot = childByPath(cm, ['OptionsContainer']);
          this._choiceBtnNodes = [];
          this._choiceButtons = [];
          this._choiceLabels = [];
          ...
          if (optRoot) {
            ...
            const ch = (_optRoot$children = optRoot.children) != null ? _optRoot$children : [];
            const opts = ch.filter(n => n.name.startsWith('OptionButton'));
            ...
            for (let i = 0; i < opts.length; i++) {
              ...
              const tn = bn.getChildByName('Text');
          ...
          if (vr != null && (_vr$choiceButtons = vr.choiceButtons) != null && _vr$choiceButtons.length) {
            for (let i = 0; i < vr.choiceButtons.length; i++) {
              var _bn$getComponent2, _ref2, _tn$getComponent2;

              const bn = vr.choiceButtons[i];
              if (!bn || this._choiceBtnNodes.includes(bn)) continue;

              this._choiceBtnNodes.push(bn);

              this._choiceButtons.push((_bn$getComponent2 = bn.getComponent(Button)) != null ? _bn$getComponent2 : bn.addComponent(Button));

              const tn = bn.getChildByName('Text');

              this._choiceLabels.push((_ref2 = (_tn$getComponent2 = tn == null ? void 0 : tn.getComponent(Label)) != null ? _tn$getComponent2 : bn.getComponent(Label)) != null ? _ref2 : bn.addComponent(Label));
            }
          }

          this._subReplyArea = childByPath(cm, ['SubReplyArea']);
          const replyTextNd = childByPath(this._subReplyArea, ['Text']);
          ...
          const toastNd = (_vr$toastItem = vr == null ? void 0 : vr.toastItem) != null ? _vr$toastItem : childByPath(this._storyLayer, ['SystemTipLayer', 'ToastItem']);
          this._toastRoot = toastNd;
          const toastTextNd = (_vr$toastTextLabel = vr == null ? void 0 : vr.toastTextLabel) != null ? _vr$toastTextLabel : childByPath(toastNd, ['Text']);
          ...
          const promptNd = (_vr$interactPrompt = vr == null ? void 0 : vr.interactPrompt) != null ? _vr$interactPrompt : childByPath(root, ['HUDLayer', 'InteractPrompt']);
          this._interactPrompt = promptNd;
          const promptTextNd = (_vr$interactPromptTex = vr == null ? void 0 : vr.interactPromptText) != null ? _vr$interactPromptTex : childByPath(promptNd, ['PromptText']);
        ...
        _wireButtons() {
          var _this$_nextBtn, _this$_nextBtn2, _this$_closeBtn, _this$_closeBtn2;
          ...
          for (let i = 0; i < this._choiceButtons.length; i++) {
            const idx = i;
            const b = this._choiceButtons[i];
            b.node.off(Button.EventType.CLICK);
            b.node.on(Button.EventType.CLICK, () => this._onPickChoice(idx), this);
          }
        }
        ...
        showInteractPrompt(visible, text = '按 E 对话') {
          this.ensureRefs();
        ...
        showToast(message, durationSec = 2.2) {
          this.ensureRefs();
        ...
        _refreshDialogueLine() {
          ...
          const line = (_this$_dlgLines$this$ = this._dlgLines[this._dlgIdx]) != null ? _this$_dlgLines$this$ : '';
        ...
        runChoice(script, onPick) {
          ...
          this._choiceClosing = false;
          const opts = (_script$options = script.options) != null ? _script$options : [];
          ...
          for (let i = 0; i < this._choiceBtnNodes.length; i++) {
            var _opts$i$text;

            const show = i < opts.length;
        ...
        _onPickChoice(btnIndex) {
          ...
          const cb = this._choiceDone;
          const script = this._runningChoice;
          ...
          const opts = (_script$options2 = script.options) != null ? _script$options2 : [];
          const picked = opts[btnIndex];
          if (!picked) return;
          ...
          const finish = () => {
            for (let i = 0; i < this._choiceButtons.length; i++) {
              this._choiceButtons[i].interactable = true;
            }
          ...
          const reply = (_picked$npcReply$trim = (_picked$npcReply = picked.npcReply) == null ? void 0 : _picked$npcReply.trim()) != null ? _picked$npcReply$trim : '';
          ...
          if (reply.length > 0 && this._subReplyArea && this._subReplyLabel) {
            ...
            for (let i = 0; i < this._choiceBtnNodes.length; i++) {
              this._choiceBtnNodes[i].active = false;
            }
