    ...
    execute: function () {
      ...
      _export("BattleScene", BattleScene = (_dec = ccclass('BattleScene'), _dec2 = property({
        ...
        onEnable() {
          ...
          this._syncBattlePortraitVisibility(); // 剧情战：房间由 startStoryBattle 发起 CREATE，此处不再走 enterBattleRoom
        ...
        _applyPlayerPetFromInfo(petId, info) {
          ...
          const classValue = Number((_ref8 = (_Class = info == null ? void 0 : info.Class) != null ? _Class : info == null || (_data = info.data) == null ? void 0 : _data.Class) != null ? _ref8 : 1);
        ...
        initEnemyUnit() {
          ...
          this.ws.request((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            ...
            const melee = Number((_ref9 = (_enemy$CurrentMelee = enemy.CurrentMelee) != null ? _enemy$CurrentMelee : enemy.Melee) != null ? _ref9 : 0);
            const shoot = Number((_ref10 = (_enemy$CurrentShootin = enemy.CurrentShooting) != null ? _enemy$CurrentShootin : enemy.Shooting) != null ? _ref10 : 0);
            const armor = Number((_ref11 = (_enemy$CurrentArmor = enemy.CurrentArmor) != null ? _enemy$CurrentArmor : enemy.Armor) != null ? _ref11 : 0);
            ...
            const initiative = Number((_ref12 = (_enemy$CurrentInitiat = enemy.CurrentInitiative) != null ? _enemy$CurrentInitiat : enemy.Initiative) != null ? _ref12 : 10);
            this.enemyUnit = {
              side: 'enemy',
        ...
        buildUnitFromRobotInfo(side, petId, info, defaultName) {
          ...
          const maxHp = Number((_ref13 = (_ref14 = (_info$MaxHP = info == null ? void 0 : info.MaxHP) != null ? _info$MaxHP : info == null ? void 0 : info.max_hp) != null ? _ref14 : info == null ? void 0 : info.hp) != null ? _ref13 : 100);
          const hp = Number((_ref15 = (_info$CurrentHP = info == null ? void 0 : info.CurrentHP) != null ? _info$CurrentHP : info == null ? void 0 : info.current_hp) != null ? _ref15 : maxHp);
          const melee = Number((_ref16 = (_info$Melee = info == null ? void 0 : info.Melee) != null ? _info$Melee : info == null ? void 0 : info.melee) != null ? _ref16 : 0);
          const shoot = Number((_ref17 = (_info$Shooting = info == null ? void 0 : info.Shooting) != null ? _info$Shooting : info == null ? void 0 : info.shoot) != null ? _ref17 : 0);
          const armor = Number((_ref18 = (_info$Armor = info == null ? void 0 : info.Armor) != null ? _info$Armor : info == null ? void 0 : info.armor) != null ? _ref18 : 0);
          const attack = melee + shoot;
          const defense = armor;
          const initiative = Number((_ref19 = (_info$Initiative = info == null ? void 0 : info.Initiative) != null ? _info$Initiative : info == null ? void 0 : info.initiative) != null ? _ref19 : 10);
          return {
            side,
            name,
            level,
        ...
        sendBattleRoomAction(action) {
          ...
          this.ws.request((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            ...
            const targetPlayerHp = Number((_ref20 = (_playerActor$hp2 = playerActor == null ? void 0 : playerActor.hp) != null ? _playerActor$hp2 : (_this$playerUnit = this.playerUnit) == null ? void 0 : _this$playerUnit.hp) != null ? _ref20 : 0);
            const targetEnemyHp = Number((_ref21 = (_enemyActor$hp2 = enemyActor == null ? void 0 : enemyActor.hp) != null ? _enemyActor$hp2 : (_this$enemyUnit = this.enemyUnit) == null ? void 0 : _this$enemyUnit.hp) != null ? _ref21 : 0); // 修复点：只同步单位/展示数据，不调 finishBattle、不显示面板；击杀时先播完本回合双方动画，再在 playServerRoundAnimation 收尾时调 finishBattle
