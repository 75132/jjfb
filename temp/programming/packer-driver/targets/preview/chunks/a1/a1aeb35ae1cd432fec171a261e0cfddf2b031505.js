  ...
  return {
    ...
    execute: function () {
      ...
      _export("WebSocketControl", WebSocketControl = (_dec = ccclass('WebSocketControl'), _dec2 = property(Button), _dec3 = property({
        ...
        onDataChanged(data) {
          var reason = data == null ? void 0 : data.reason;
        ...
        showLoadingAndRecover(reason) {
          ...
          var sceneName = ((_director$getScene2 = director.getScene()) == null ? void 0 : _director$getScene2.name) || '';
...
//# sourceMappingURL=a1aeb35ae1cd432fec171a261e0cfddf2b031505.js.map