System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, EditBox, Button, Label, director, WebSocketManager, GameConfig, ChangePasswordPanel, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _crd, ccclass, property, Login;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Login", Login = (_dec = ccclass('Login'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Node), _dec8 = property(_crd && ChangePasswordPanel === void 0 ? (_reportPossibleCrUseOfChangePasswordPanel({
        error: Error()
      }), ChangePasswordPanel) : ChangePasswordPanel), _dec9 = property(EditBox), _dec10 = property(EditBox), _dec11 = property(Label), _dec12 = property(Node), _dec(_class = (_class2 = class Login extends Component {
        constructor() {
          super(...arguments);
        ...
        start() {
          ...
          if (token) {
            ...
            try {
              var userId = this.webSocketManager.getUserId();
              var characterId = this.webSocketManager.getCharacterId();
              var authMsg = {
            ...
            } catch (_unused2) {} // 不在这里提前自动跳转，改为等待 auth_response 成功后再决定跳转，避免脏本地ID导致误跳。
        ...
        onLoginClick() {
          ...
          var account = this.accountEditBox.string.trim();
        ...
        handleLoginResponse(data) {
          ...
          if (data.success) {
            ...
            if (responseData.token || data.token) {
              var token = responseData.token || data.token;
              this.webSocketManager.saveToken(token); // 保存 token_expires_at（如果服务器下发），用于断线/重进后的有效性判断

              var tokenExpiresAt = responseData.token_expires_at || data.token_expires_at;
            ...
            if (responseData.refresh_token || data.refresh_token) {
              ...
              var refreshToken = responseData.refresh_token || data.refresh_token;

              var _tokenExpiresAt = responseData.token_expires_at || data.token_expires_at;

              var refreshTokenExpiresAt = responseData.refresh_token_expires_at || data.refresh_token_expires_at; // TODO: 保存refresh_token和过期时间到localStorage
            ...
            var userId = responseData.user_id || data.user_id;
            ...
            var errorMessage = data.message || '登录失败';
        ...
        handleRegisterResponse(data) {
          ...
          if (data.success) {
            ...
            // 处理错误响应
            var errorMessage = data.message || '注册失败';
        ...
        handleAuthSuccess(data) {
          ...
          if (data != null && data.user_id) {
            var serverCharacterId = (data == null ? void 0 : data.character_id) || '';
        ...
        onOpenChangePasswordPanel() {
          ...
          var account = ((_this$accountEditBox = this.accountEditBox) == null || (_this$accountEditBox = _this$accountEditBox.string) == null ? void 0 : _this$accountEditBox.trim()) || '';
...
//# sourceMappingURL=c78dad42800c6df40b8b2278d560f59f1b24eb53.js.map