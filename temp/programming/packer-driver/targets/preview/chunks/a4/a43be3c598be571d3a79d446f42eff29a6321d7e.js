      ...
      _export("PlayerStateSync", PlayerStateSync = (_dec = ccclass('PlayerStateSync'), _dec2 = property({
        ...
        constructor() {
          ...
          this.onPlayerInfo = resp => {
            ...
            var roleName = String((_data$role_name = data.role_name) != null ? _data$role_name : '');
            var pos = data.position || {};
            var x = Number(pos.x);
            var y = Number(pos.y);
            if (!Number.isFinite(x) || !Number.isFinite(y)) return; // 本地玩家名字显示：写入 Player.prefab 下挂的 Name/Label。

            var nameLabel = this._resolveNameLabel();
            ...
            var spriteIndex = Number(data.Sprite || 0);
        ...
        onLoad() {
          ...
          (_this$playerMove = this.playerMove) == null || _this$playerMove.onStep(null);
        }
        ...
        onDestroy() {
          var _this$ws, _this$ws2, _this$playerMove2;
          ...
          (_this$playerMove2 = this.playerMove) == null || _this$playerMove2.onStep(null);
        }
        ...
        _resolvePlayerRefs() {
          var _this$playerMove3, _worldRoot$getCompone;

          if ((_this$playerMove3 = this.playerMove) != null && (_this$playerMove3 = _this$playerMove3.node) != null && _this$playerMove3.isValid) {
            if (!this.animRuntime) {
              this.animRuntime = this.playerMove.getComponent(_crd && PlayerAnimRuntime === void 0 ? (_reportPossibleCrUseOfPlayerAnimRuntime({
                error: Error()
              }), PlayerAnimRuntime) : PlayerAnimRuntime);
            }
          ...
          var worldRoot = this.node.getChildByName('WorldRoot');
          var mv = (_worldRoot$getCompone = worldRoot == null ? void 0 : worldRoot.getComponentInChildren(_crd && PlayerGridMove === void 0 ? (_reportPossibleCrUseOfPlayerGridMove({
            error: Error()
          }), PlayerGridMove) : PlayerGridMove)) != null ? _worldRoot$getCompone : null;

          if (mv) {
            var _this$animRuntime2;

            this.playerMove = mv;
            this.animRuntime = (_this$animRuntime2 = this.animRuntime) != null ? _this$animRuntime2 : mv.getComponent(_crd && PlayerAnimRuntime === void 0 ? (_reportPossibleCrUseOfPlayerAnimRuntime({
              error: Error()
            }), PlayerAnimRuntime) : PlayerAnimRuntime);
          }
        }

        _applyFallbackSpawnIfNeeded() {
          if (this.restored) return;
          var mv = this.playerMove;
          if (!mv) return;
          var p = mv.node.position;
...
//# sourceMappingURL=a43be3c598be571d3a79d446f42eff29a6321d7e.js.map