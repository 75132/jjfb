      ...
      _export("WorldOnlineSync", WorldOnlineSync = (_dec = ccclass('WorldOnlineSync'), _dec2 = property({
        ...
        constructor() {
          ...
          this.onDataChanged = ev => {
            var r = ev == null ? void 0 : ev.reason;
          ...
          this.onWorldJoin = msg => {
            ...
            if (!this.enableOnline) return;
            var selfCid = this.ws.getCharacterId();
            var p = (msg == null ? void 0 : msg.player) || (msg == null || (_msg$data = msg.data) == null ? void 0 : _msg$data.player);
          ...
          this.onWorldLeave = msg => {
            ...
            var cid = (_msg$character_id = msg == null ? void 0 : msg.character_id) != null ? _msg$character_id : msg == null || (_msg$data2 = msg.data) == null ? void 0 : _msg$data2.character_id;
            if (!cid) return;
          ...
          this.onWorldMove = msg => {
            ...
            if (!this.enableOnline) return;
            var selfCid = this.ws.getCharacterId();
            var cid = msg == null ? void 0 : msg.character_id;
            if (!cid || String(cid) === String(selfCid)) return;
            var pos = msg.position || (msg == null || (_msg$data3 = msg.data) == null ? void 0 : _msg$data3.position);
            if (!pos) return;
            var x = Number(pos.x);
            var y = Number(pos.y);
            if (!Number.isFinite(x) || !Number.isFinite(y)) return;
            var facing = String(msg.facing || 'down');
            var moving = Boolean(msg.moving);
            var cidStr = String(cid);

            var node = this._remoteByCid.get(cidStr);
        ...
        _setRemoteNameLabel(node, cid, roleName) {
          ...
          var label = (_node$getChildByName$ = (_node$getChildByName = node.getChildByName('Name')) == null ? void 0 : _node$getChildByName.getComponent(Label)) != null ? _node$getChildByName$ : null;
          if (!label) return;
          var s = String(roleName != null ? roleName : '');

          if (s.length > 0) {
            this._remoteRoleNameByCid.set(cid, s);
          }

          var final = s.length > 0 ? s : (_this$_remoteRoleName = this._remoteRoleNameByCid.get(cid)) != null ? _this$_remoteRoleName : '';
          label.string = final;
        ...
        _setLocalNameLabel(roleName) {
          ...
          var node = (_this$localPlayerMove = this.localPlayerMove) == null ? void 0 : _this$localPlayerMove.node;
          if (!node || !node.isValid) return;
          var label = (_node$getChildByName$2 = (_node$getChildByName2 = node.getChildByName('Name')) == null ? void 0 : _node$getChildByName2.getComponent(Label)) != null ? _node$getChildByName$2 : null;
          if (!label) return;
          var s = String(roleName != null ? roleName : '');
          label.string = s;
        ...
        _getRemoteParent() {
          var _this$remoteMountRoot, _this$localPlayerMove3, _lp$parent;

          if ((_this$remoteMountRoot = this.remoteMountRoot) != null && _this$remoteMountRoot.isValid) {
            return this.remoteMountRoot;
          }

          var lp = (_this$localPlayerMove3 = this.localPlayerMove) == null ? void 0 : _this$localPlayerMove3.node;
        ...
        _configureRemoteInstance(node) {
          ...
          var pgm = node.getComponent(_crd && PlayerGridMove === void 0 ? (_reportPossibleCrUseOfPlayerGridMove({
            error: Error()
          }), PlayerGridMove) : PlayerGridMove);
          ...
          var st = node.getComponent(_crd && PlayerStateSync === void 0 ? (_reportPossibleCrUseOfPlayerStateSync({
            error: Error()
          ...
          var psr = node.getComponent(_crd && PlayerSceneRefs === void 0 ? (_reportPossibleCrUseOfPlayerSceneRefs({
            error: Error()
          ...
          var ac = node.getComponent(Animation);
        ...
        update(_dt) {
          ...
          var parent = this._getRemoteParent();

          if (!(parent != null && parent.isValid) || !this.remotePlayerPrefab) {
            return;
          }

          var batch = [...this._deferredRemoteRawByCid.values()];
        ...
        onDestroy() {
          var _this$localPlayerMove4, _this$ws, _this$ws2, _this$ws3, _this$ws4, _this$ws5, _this$ws6;

          this.unschedule(this._intervalResync);
          (_this$localPlayerMove4 = this.localPlayerMove) == null || _this$localPlayerMove4.onStep(null);
        ...
        _applyEnterOthers(r, cid) {
          ...
          var payload = r.data && typeof r.data === 'object' ? r.data : r;
          var others = (_payload$others = payload.others) != null ? _payload$others : r.others;
        ...
        spawnOrUpdateRemote(raw) {
          var cid = String(raw.character_id || '');
        ...
        _spawnRemoteOnParent(raw, parent) {
          ...
          var node = this._remoteByCid.get(cid);
          ...
          if (!node || !node.isValid) {
            ...
            var _rc = node.getComponent(_crd && RemoteAvatarController === void 0 ? (_reportPossibleCrUseOfRemoteAvatarController({
              error: Error()
            }), RemoteAvatarController) : RemoteAvatarController);

            if (!_rc) {
              _rc = node.addComponent(_crd && RemoteAvatarController === void 0 ? (_reportPossibleCrUseOfRemoteAvatarController({
                error: Error()
              }), RemoteAvatarController) : RemoteAvatarController);
            }

            _rc.characterId = cid;
            var anim = node.getComponent(_crd && PlayerAnimRuntime === void 0 ? (_reportPossibleCrUseOfPlayerAnimRuntime({
              error: Error()
            ...
            var sp = Number(raw.Sprite || raw.sprite || 0);
          ...
          var rc = node.getComponent(_crd && RemoteAvatarController === void 0 ? (_reportPossibleCrUseOfRemoteAvatarController({
            error: Error()
          }), RemoteAvatarController) : RemoteAvatarController);
        ...
        removeRemote(cid) {
          var n = this._remoteByCid.get(cid);
...
//# sourceMappingURL=be2bd12fd1dac0928130df340ee2c8aec9efe126.js.map