      ...
      _export("BattleTriggerOnContact", BattleTriggerOnContact = (_dec = ccclass('BattleTriggerOnContact'), _dec2 = property({
        ...
        constructor() {
          ...
          this._onBeginContact = (_self, other) => {
            ...
            var otherNode = other == null ? void 0 : other.node;
            if (!otherNode) return;

            var playerMove = this._findPlayerGridMoveComponent(otherNode);
        ...
        update() {
          ...
          var battleActive = Boolean((_this$battleRoot5 = this.battleRoot) == null ? void 0 : _this$battleRoot5.active); // 战斗从 active -> inactive：如果玩家当时还在碰撞框里，则进入“等待 Enter 才能再次开战”
        ...
        _findPlayerGridMoveComponent(node) {
          ...
          while (cur && guard++ < 8) {
            var comp = cur.getComponent(_crd && PlayerGridMove === void 0 ? (_reportPossibleCrUseOfPlayerGridMove({
              error: Error()
        ...
        _pollTouchOverlap() {
          ...
          var a = this._triggerBox.worldAABB;
          var b = this._playerBox.worldAABB;
          if (!a || !b) return;
          var hit = a.x < b.x + b.width && a.x + a.width > b.x && a.y < b.y + b.height && a.y + a.height > b.y;
...
//# sourceMappingURL=9db5c23f7e30d0191b01f2b33df45a34176d2fdc.js.map