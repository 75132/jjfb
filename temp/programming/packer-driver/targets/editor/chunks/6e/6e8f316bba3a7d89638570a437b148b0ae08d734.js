    ...
    execute: function () {
      ...
      _export("StoryWorldInteract", StoryWorldInteract = (_dec = ccclass('StoryWorldInteract'), _dec2 = property({
        ...
        static ensureOn(gameArea) {
          ...
          let story = gameArea.getComponent(StoryWorldInteract);
          if (!story) story = gameArea.addComponent(StoryWorldInteract);
          const npc = gameArea.getComponentInChildren(_crd && MapNpcInteract === void 0 ? (_reportPossibleCrUseOfMapNpcInteract({
            error: Error()
          ...
          const canvasRoot = gameArea.getChildByName('CanvasRoot(UI)');

          if (canvasRoot != null && canvasRoot.isValid) {
            let ui = canvasRoot.getComponent(_crd && StoryUIViewController === void 0 ? (_reportPossibleCrUseOfStoryUIViewController({
              error: Error()
            }), StoryUIViewController) : StoryUIViewController);
        ...
        start() {
          if (!this.mapConfig) {
            const npc = this.node.getComponentInChildren(_crd && MapNpcInteract === void 0 ? (_reportPossibleCrUseOfMapNpcInteract({
              error: Error()
            }), MapNpcInteract) : MapNpcInteract);
        ...
        update() {
          ...
          const npcs = this.node.getComponentsInChildren(_crd && MapNpcInteract === void 0 ? (_reportPossibleCrUseOfMapNpcInteract({
            error: Error()
          }), MapNpcInteract) : MapNpcInteract);
          let best = null;
          let bestD = this._model.maxInteractDistance + 1;
          ...
          for (let i = 0; i < npcs.length; i++) {
            ...
            const anchor = (_c$interactAnchor = c.interactAnchor) != null && _c$interactAnchor.isValid ? c.interactAnchor : c.node;
            const aw = anchor.worldPosition;
            const dx = pw.x - aw.x;
            const dy = pw.y - aw.y;
        ...
        _rebuildModel() {
          ...
          const code = (_this$_model$raw$mapC = this._model.raw.mapCode) != null ? _this$_model$raw$mapC : `map_${(_this$_model$raw$mapI = this._model.raw.mapId) != null ? _this$_model$raw$mapI : 0}`;
          ...
          if (!((_this$ui = this.ui) != null && _this$ui.isValid)) {
            ...
            const canvasRoot = this.node.getChildByName('CanvasRoot(UI)');
        ...
        _resolvePlayerNode() {
          ...
          const root = (_this$node$getChildBy = this.node.getChildByName('WorldRoot')) != null ? _this$node$getChildBy : this.node;
          const pgms = root.getComponentsInChildren(_crd && PlayerGridMove === void 0 ? (_reportPossibleCrUseOfPlayerGridMove({
            error: Error()
          ...
          const fallback = (_pgms$0$node = (_pgms$ = pgms[0]) == null ? void 0 : _pgms$.node) != null ? _pgms$0$node : (_this$node$getCompone = this.node.getComponentInChildren(_crd && PlayerGridMove === void 0 ? (_reportPossibleCrUseOfPlayerGridMove({
            error: Error()
        ...
        _onKeyDown(e) {
          ...
          const ev = this._model.getFirstEligibleEvent(this._nearest.npcUid, this._taskState);
        ...
        _runEvent(ev) {
          ...
          if (t === 'dialog') {
            const dlg = model.getDialogue(ev.client.dialogueScriptId);
          ...
          if (t === 'task') {
            ...
            const hint = (_ev$client$taskUiHint = ev.client.taskUiHint) != null ? _ev$client$taskUiHint : '';
          ...
          if (t === 'battle' || t === 'teleport') {
            const cid = ev.client.choiceScriptId;
            const choice = model.getChoice(cid);
