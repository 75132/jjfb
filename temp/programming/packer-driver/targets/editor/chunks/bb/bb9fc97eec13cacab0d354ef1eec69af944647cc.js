      ...
      _export("MiniGame1", MiniGame1 = (_dec = ccclass('MiniGame1'), _dec2 = property({
        ...
        constructor(...args) {
          ...
          this.onMainClaimClick = () => {
            ...
            const sec = (_this$_lastPayload$se = (_this$_lastPayload = this._lastPayload) == null ? void 0 : _this$_lastPayload.seconds_until_eligible) != null ? _this$_lastPayload$se : REQUIRED_SECONDS;
        ...
        refreshOnlineTimeLabels() {
          ...
          const base = (_ref = (_this$_lastSyncOnline = this._lastSyncOnlineSecondsBase) != null ? _this$_lastSyncOnline : this._lastPayload.online_seconds) != null ? _ref : 0;
          const recvAt = this._lastSyncRecvAtMs || Date.now();
          const elapsedSec = (Date.now() - recvAt) / 1000; // 服务端每次累计 delta 最高 45s，这里用同样 cap 来估算
        ...
        maybeAutoSyncForEligibility() {
          ...
          const base = (_this$_lastSyncOnline2 = this._lastSyncOnlineSecondsBase) != null ? _this$_lastSyncOnline2 : 0;
          const recvAt = this._lastSyncRecvAtMs || Date.now();
        ...
        resolveBindings() {
          ...
          if (mainClaim) {
            ...
            if (!this.mainClaimButtonLabel) {
              ...
              this.mainClaimButtonLabel = (_ln$getComponent2 = ln == null ? void 0 : ln.getComponent(Label)) != null ? _ln$getComponent2 : null;
            }
          }
        ...
        unbindButtons() {
          const offClick = (btnNode, handler) => {
        ...
        setMainClaimInteractable(enabled) {
          ...
          const btn = (_this$_mainClaimBtnNo = this._mainClaimBtnNode) == null ? void 0 : _this$_mainClaimBtnNo.getComponent(Button);
        ...
        formatClaimErrorMessage(resp) {
          ...
          const msg = String((_resp$message = resp == null ? void 0 : resp.message) != null ? _resp$message : '').trim();
          const code = resp == null ? void 0 : resp.code;
        ...
        applyPayload(d) {
          ...
          if (this.energyLabel) {
            var _d$energy_blocks;

            this.energyLabel.string = String((_d$energy_blocks = d.energy_blocks) != null ? _d$energy_blocks : 0);
          }
          ...
          if (this.timeUntilEligibleLabel) {
            ...
            const need = (_d$seconds_until_elig = d.seconds_until_eligible) != null ? _d$seconds_until_elig : 0;
            this.timeUntilEligibleLabel.string = need > 0 ? this.fmtDuration(need) : '已达要求';
          }
        ...
        openResultPanel() {
          ...
          const code = (_d$result_tip_code = d == null ? void 0 : d.result_tip_code) != null ? _d$result_tip_code : 5;

          if (this.resultPlayerNameLabel) {
            // 始终显示本期中奖玩家名字（若无人中奖则给出占位）
            const winName = ((d == null ? void 0 : d.winner_display_name) || '').trim();
          ...
          if (this.resultTipLabel) {
            ...
            this.resultTipLabel.string = (_RESULT_TIP$code = RESULT_TIP[code]) != null ? _RESULT_TIP$code : RESULT_TIP[5];
          }

          const issueKey = this.getIssueKey(d != null ? d : null);
          if (this.resultIssueNumLabel) this.resultIssueNumLabel.string = issueKey;
        ...
        getIssueKey(d) {
          ...
          const iss = ((_d$issue = d == null ? void 0 : d.issue) != null ? _d$issue : '').trim();
        ...
        formatIssueKeyFromDay(day) {
          ...
          const st = (_this$_lastPayload$se2 = (_this$_lastPayload5 = this._lastPayload) == null ? void 0 : _this$_lastPayload5.server_time) != null ? _this$_lastPayload$se2 : '';
...
//# sourceMappingURL=bb9fc97eec13cacab0d354ef1eec69af944647cc.js.map