    ...
    execute: function () {
      ...
      _export("WorldOnlineSync", WorldOnlineSync = (_dec = ccclass('WorldOnlineSync'), _dec2 = property({
        ...
        _resolveLocalPlayerMove() {
          ...
          var wr = (_this$worldRoot = this.worldRoot) != null ? _this$worldRoot : this.node.getChildByName('WorldRoot');
        ...
        _getRemoteParent() {
          ...
          var lp = (_this$localPlayerMove4 = this.localPlayerMove) == null ? void 0 : _this$localPlayerMove4.node;
