System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfGameMenu(extras) {
    _reporterNs.report("GameMenu", "../Game/GameMenu", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "4e0caBUG5ZLxr2tqytT3Ov/", "CentralMenu", undefined);
      ...
      _export("CentralMenu", CentralMenu = (_dec = ccclass('CentralMenu'), _dec2 = property({
        ...
        bindButtons() {
          ...
          var _loop = function _loop(i) {
            var btn = buttons[i];
            var panel = panels[i];
            if (!btn || !panel) return 1; // continue

            btn.node.on(Button.EventType.CLICK, () => {
              _this.togglePanelByIndex(i);
            }, _this);
          };
        ...
        isManagedByGameMenu(node) {
          ...
          try {
            ...
            while (current) {
              var menu = current.getComponent(_crd && GameMenu === void 0 ? (_reportPossibleCrUseOfGameMenu({
                error: Error()
              }), GameMenu) : GameMenu);
              if (menu) return true;
        ...
        togglePanelByIndex(index) {
          ...
          if (!currentPanel) return; // 始终打开目标面板，并关闭其他面板（避免重复绑定导致“打开后又被关回去”）
...
//# sourceMappingURL=80c4cb71d0b15404b99ef7167a42a0e945ed4992.js.map