    ...
    execute: function () {
      ...
      _export("BattleScene", BattleScene = (_dec = ccclass('BattleScene'), _dec2 = property({
        ...
        _bindNetworkReconnect() {
          ...
          const node = (_this$ws5 = this.ws) == null ? void 0 : _this$ws5.node;
        ...
        applyServerRoomState(state, isNewRoom = false, forRoundAnimation = false) {
          ...
          const classValue = Number((_ref3 = (_playerRaw$Class = playerRaw == null ? void 0 : playerRaw.Class) != null ? _playerRaw$Class : playerRaw == null || (_playerRaw$data = playerRaw.data) == null ? void 0 : _playerRaw$data.Class) != null ? _ref3 : 1);
          this.updatePlayer1ClassIcon(classValue); // 根据出场职业（Class）刷新 敌人职业图标（重连/恢复战斗也会走到这里）

          const enemyClassValue = Number((_ref4 = (_enemyRaw$Class = enemyRaw == null ? void 0 : enemyRaw.Class) != null ? _enemyRaw$Class : enemyRaw == null || (_enemyRaw$data = enemyRaw.data) == null ? void 0 : _enemyRaw$data.Class) != null ? _ref4 : 1);
        ...
        _getRemainingCommandSecondsFromState(state) {
          ...
          const direct = (_ref5 = (_n = n(state.remaining_command_seconds)) != null ? _n : n(state.remaining_seconds)) != null ? _ref5 : n(state.command_remaining_seconds);
          ...
          const startTs = (_ref6 = (_n3 = n(state.round_start_ts)) != null ? _n3 : n(state.round_start_time)) != null ? _ref6 : n(state.command_phase_start_ts);
        ...
        checkAndStartBattle() {
          ...
          const characterId = (_this$ws$getCharacter5 = (_this$ws7 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter5.call(_this$ws7);
        ...
        initPlayerUnit() {
          ...
          this.ws.request((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            ...
            const classValue = Number((_ref7 = (_Class = (_info = info) == null ? void 0 : _info.Class) != null ? _Class : (_info2 = info) == null || (_info2 = _info2.data) == null ? void 0 : _info2.Class) != null ? _ref7 : 1);
        ...
        initEnemyUnit() {
          ...
          this.ws.request((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            ...
            const melee = Number((_ref8 = (_enemy$CurrentMelee = enemy.CurrentMelee) != null ? _enemy$CurrentMelee : enemy.Melee) != null ? _ref8 : 0);
            const shoot = Number((_ref9 = (_enemy$CurrentShootin = enemy.CurrentShooting) != null ? _enemy$CurrentShootin : enemy.Shooting) != null ? _ref9 : 0);
            const armor = Number((_ref10 = (_enemy$CurrentArmor = enemy.CurrentArmor) != null ? _enemy$CurrentArmor : enemy.Armor) != null ? _ref10 : 0);
            ...
            const initiative = Number((_ref11 = (_enemy$CurrentInitiat = enemy.CurrentInitiative) != null ? _enemy$CurrentInitiat : enemy.Initiative) != null ? _ref11 : 10);
            this.enemyUnit = {
              side: 'enemy',
        ...
        buildUnitFromRobotInfo(side, petId, info, defaultName) {
          ...
          const maxHp = Number((_ref12 = (_ref13 = (_info$MaxHP = info == null ? void 0 : info.MaxHP) != null ? _info$MaxHP : info == null ? void 0 : info.max_hp) != null ? _ref13 : info == null ? void 0 : info.hp) != null ? _ref12 : 100);
          const hp = Number((_ref14 = (_info$CurrentHP = info == null ? void 0 : info.CurrentHP) != null ? _info$CurrentHP : info == null ? void 0 : info.current_hp) != null ? _ref14 : maxHp);
          const melee = Number((_ref15 = (_info$Melee = info == null ? void 0 : info.Melee) != null ? _info$Melee : info == null ? void 0 : info.melee) != null ? _ref15 : 0);
          const shoot = Number((_ref16 = (_info$Shooting = info == null ? void 0 : info.Shooting) != null ? _info$Shooting : info == null ? void 0 : info.shoot) != null ? _ref16 : 0);
          const armor = Number((_ref17 = (_info$Armor = info == null ? void 0 : info.Armor) != null ? _info$Armor : info == null ? void 0 : info.armor) != null ? _ref17 : 0);
          const attack = melee + shoot;
          const defense = armor;
          const initiative = Number((_ref18 = (_info$Initiative = info == null ? void 0 : info.Initiative) != null ? _info$Initiative : info == null ? void 0 : info.initiative) != null ? _ref18 : 10);
          return {
            side,
            name,
            level,
        ...
        sendBattleRoomAction(action) {
          ...
          this.ws.request((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            ...
            const playerActor = state.player;
            const enemyActor = state.enemy; // 服务器结算后的最终 HP

            const targetPlayerHp = Number((_ref19 = (_playerActor$hp2 = playerActor == null ? void 0 : playerActor.hp) != null ? _playerActor$hp2 : (_this$playerUnit = this.playerUnit) == null ? void 0 : _this$playerUnit.hp) != null ? _ref19 : 0);
            const targetEnemyHp = Number((_ref20 = (_enemyActor$hp2 = enemyActor == null ? void 0 : enemyActor.hp) != null ? _enemyActor$hp2 : (_this$enemyUnit = this.enemyUnit) == null ? void 0 : _this$enemyUnit.hp) != null ? _ref20 : 0); // 修复点：只同步单位/展示数据，不调 finishBattle、不显示面板；击杀时先播完本回合双方动画，再在 playServerRoundAnimation 收尾时调 finishBattle
            ...
            const damageToEnemy = Math.max(0, this.lastRoundEnemyHp - targetEnemyHp); // 为了播动画，把本地 HP 暂时“回滚”到回合开始前
        ...
        finishBattle(winner, reason) {
          ...
          try {
            ...
            const cid = (_this$ws$getCharacter10 = (_this$ws12 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter10.call(_this$ws12);
            ...
            if (cid) {
              ...
              const uid = (_this$ws$getUserId = (_this$ws13 = this.ws).getUserId) == null ? void 0 : _this$ws$getUserId.call(_this$ws13);
        ...
        refreshPlayerShowFromServer() {
          ...
          const characterId = (_this$ws$getCharacter11 = (_this$ws14 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter11.call(_this$ws14);
          if (!characterId) return;
          ...
          const userId = (_this$ws$getUserId2 = (_this$ws15 = this.ws).getUserId) == null ? void 0 : _this$ws$getUserId2.call(_this$ws15);
        ...
        initMechAttributeBindings(root) {
          ...
          const nodeKeys = ['Melee', 'Armor', 'Accuracy', 'Corrosion', 'Initiative', 'Block', 'ParticleShield', 'ArmorPenetration', 'Shooting', 'Evasion', 'Lethality', 'Resistance', 'Counterattack'];
