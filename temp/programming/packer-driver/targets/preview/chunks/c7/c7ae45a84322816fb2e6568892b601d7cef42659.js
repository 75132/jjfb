System.register(["cc"], function (_export, _context) {
  ...
  function localStoryStorageKey(mapCode, characterId) {
    var cid = characterId == null ? void 0 : characterId.trim();
  ...
  function buildLocalCompletePayload(ev, choiceId) {
    ...
    for (var raw of (_ev$server$effects = (_ev$server = ev.server) == null ? void 0 : _ev$server.effects) != null ? _ev$server$effects : []) {
      var _ev$server$effects, _ev$server, _eff$choiceId;

      if (!raw || typeof raw !== 'object') continue;
      var eff = raw;
      var effChoice = String((_eff$choiceId = eff.choiceId) != null ? _eff$choiceId : '').trim();
      if (effChoice && choiceId && effChoice !== choiceId) continue;
      applied.push(_extends({}, eff));
    }
