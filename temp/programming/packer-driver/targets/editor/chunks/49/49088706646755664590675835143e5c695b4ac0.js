      ...
      _export("RobotList", RobotList = (_dec = ccclass('RobotList'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(ScrollView), _dec7 = property(Node), _dec8 = property({
        ...
        sortByBattleTeam() {
          ...
          for (const p of this.currentPets) {
            ...
            const id = this.normPetId(String((_ref4 = (_ref5 = (_p$pet_id2 = p.pet_id) != null ? _p$pet_id2 : p._id) != null ? _ref5 : p.id) != null ? _ref4 : ''));
        ...
        refreshListUI() {
          ...
          const sid = this.selectedPet ? this.normPetId(String((_ref6 = (_ref7 = (_this$selectedPet$pet = this.selectedPet.pet_id) != null ? _this$selectedPet$pet : this.selectedPet._id) != null ? _ref7 : this.selectedPet.id) != null ? _ref6 : '')) : '';
          this.sortByBattleTeam();
          this.bgColorMap.clear();
          this.renderList(this.currentPets);
        ...
        fillRow(node, pet, _index) {
          ...
          const id = String((_ref10 = (_ref11 = (_pet$pet_id = pet.pet_id) != null ? _pet$pet_id : pet._id) != null ? _ref11 : pet.id) != null ? _ref10 : '');
          const form = Number((_ref12 = (_pet$Form = pet.Form) != null ? _pet$Form : pet.Fo) != null ? _ref12 : 0);
          ...
          if (tagN) {
            ...
            if (tl) {
              ...
              const pid = String((_ref13 = (_ref14 = (_pet$pet_id2 = pet.pet_id) != null ? _pet$pet_id2 : pet._id) != null ? _ref14 : pet.id) != null ? _ref13 : '');
        ...
        updateRowBattleFilter(node, pet) {
          ...
          const id = this.normPetId(String((_ref15 = (_ref16 = (_pet$pet_id3 = pet.pet_id) != null ? _pet$pet_id3 : pet._id) != null ? _ref16 : pet.id) != null ? _ref15 : ''));
        ...
        bindSetAndActions(node, pet, index) {
          ...
          const petId = String((_ref17 = (_ref18 = (_pet$pet_id4 = pet.pet_id) != null ? _pet$pet_id4 : pet._id) != null ? _ref18 : pet.id) != null ? _ref17 : ''); // 将 pet 数据绑定到节点，方便后续使用
        ...
        onDeploy(petId, row, panel) {
          ...
          if (nodePet) {
            ...
            const correctId = String((_ref19 = (_ref20 = (_nodePet$pet_id = nodePet.pet_id) != null ? _nodePet$pet_id : nodePet._id) != null ? _ref20 : nodePet.id) != null ? _ref19 : '');
        ...
        submitBattleTeam(team) {
          ...
          for (const id of team) {
            ...
            const pet = this.currentPets.find(p => {
              ...
              const pid = this.normPetId(String((_ref21 = (_ref22 = (_p$pet_id4 = p.pet_id) != null ? _p$pet_id4 : p._id) != null ? _ref22 : p.id) != null ? _ref21 : ''));
          ...
          const validPets = normalizedTeam.filter(pid => {
            ...
            const pet = this.currentPets.find(p => {
              ...
              return this.normPetId(String((_ref23 = (_ref24 = (_p$pet_id5 = p.pet_id) != null ? _p$pet_id5 : p._id) != null ? _ref24 : p.id) != null ? _ref23 : '')) === pn;
            });
          ...
          console.log('[RobotList] 当前机甲列表 petIds:', this.currentPets.map(p => {
            ...
            return String((_ref25 = (_ref26 = (_p$pet_id6 = p.pet_id) != null ? _p$pet_id6 : p._id) != null ? _ref26 : p.id) != null ? _ref25 : '');
          }));
          const setReq = {
            character_id: cid,
        ...
        onConfirm() {
          ...
          const petId = String((_ref27 = (_ref28 = (_this$selectedPet$pet2 = this.selectedPet.pet_id) != null ? _this$selectedPet$pet2 : this.selectedPet._id) != null ? _ref28 : this.selectedPet.id) != null ? _ref27 : '');
