System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Button, Label, instantiate, Sprite, UITransform, SpriteAtlas, JsonAsset, assetManager, Color, input, Input, Vec3, EditBox, WebSocketManager, GameConfig, RobotList, RobotEvolutionEffect, DataCacheManager, ResourceManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _descriptor21, _descriptor22, _descriptor23, _descriptor24, _crd, ccclass, property, BagItem;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Button', 'Label', 'instantiate', 'Sprite', 'SpriteFrame', 'UITransform', 'SpriteAtlas', 'resources', 'JsonAsset', 'assetManager', 'Color', 'EventTouch', 'input', 'Input', 'Vec3', 'EditBox', 'tween', 'Tween']);
      ...
      _export("BagItem", BagItem = (_dec = ccclass('BagItem'), _dec2 = property(Node), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Button), _dec11 = property(Button), _dec12 = property(EditBox), _dec13 = property(Button), _dec14 = property(Button), _dec15 = property(Label), _dec16 = property(SpriteAtlas), _dec17 = property(SpriteAtlas), _dec18 = property(Node), _dec19 = property(Node), _dec20 = property(Button), _dec21 = property(Button), _dec22 = property(Button), _dec23 = property(_crd && RobotList === void 0 ? (_reportPossibleCrUseOfRobotList({
        error: Error()
      }), RobotList) : RobotList), _dec24 = property(Node), _dec25 = property(Label), _dec(_class = (_class2 = class BagItem extends Component {
        constructor(...args) {
          super(...args);
          ...
          // 随机物品数量输入框
          _initializerDefineProperty(this, "nextPageBtn", _descriptor12, this);

          // 下一页按钮
          _initializerDefineProperty(this, "prevPageBtn", _descriptor13, this);

          // 上一页按钮
          _initializerDefineProperty(this, "pageNumberLabel", _descriptor14, this);

          // 显示页码 1/4 之类
          _initializerDefineProperty(this, "ui2Atlas", _descriptor15, this);

          // UI2 图集（IconSet2-9 格式）
          _initializerDefineProperty(this, "iconSet2Atlas", _descriptor16, this);

          // IconSet2 图集（IconSet2_232 格式）
          _initializerDefineProperty(this, "introductionPanel", _descriptor17, this);

          // 统一的物品详情面板（放在 Bag 面板下，全程只用一个）
          _initializerDefineProperty(this, "useItemPanel", _descriptor18, this);

          // 使用物品窗口（UseItem）
          _initializerDefineProperty(this, "useItemButton", _descriptor19, this);

          // 使用物品按钮（点击后显示使用窗口）
          _initializerDefineProperty(this, "useBtn", _descriptor20, this);

          // 使用窗口内的"使用"按钮
          _initializerDefineProperty(this, "discardBtn", _descriptor21, this);

          // 使用窗口内的"丢弃"按钮
          _initializerDefineProperty(this, "robotList", _descriptor22, this);

          // 机甲列表面板（用于选择机甲使用物品）
          _initializerDefineProperty(this, "errorTipsPanel", _descriptor23, this);

          // ErrorTips 面板节点（BagPanel下的ErrorTips）
          _initializerDefineProperty(this, "errorTipsLabel", _descriptor24, this);
          ...
          this.onBagItems = data => {
            ...
            if (data && data.success) {
              // 版本号更新（总是更新，不管是否匹配）
              const serverVersion = data.bag_version || responseData.bag_version || 0; // 新增：检查版本号匹配（但需要考虑分类）
              ...
              const serverItems = Array.isArray(responseData.items || data.items) ? responseData.items || data.items : []; // 同步分页信息（兼容旧服务端：字段不存在时给默认值）

              const serverPage = typeof (responseData.page || data.page) === 'number' && (responseData.page || data.page) > 0 ? responseData.page || data.page : this.currentPage || 1;
              const serverTotalPages = typeof (responseData.total_pages || data.total_pages) === 'number' && (responseData.total_pages || data.total_pages) > 0 ? responseData.total_pages || data.total_pages : this.totalPages || 1; // 关键修复：如果当前页被删除后变成空页，服务器会返回调整后的页码
              ...
              const msg = (data == null ? void 0 : data.message) || (responseData == null ? void 0 : responseData.message) || '获取背包数据失败';
          ...
          this.onBagItemsUpdate = data => {
            if (data && data.success) {
              // 重置版本号，下次请求时强制获取最新数据
              this.localBagVersion = 0; // 立即刷新，不使用延迟，确保数据同步
          ...
          this.onUseItemResponse = data => {
            ...
            // 关键修复：如果使用物品是装备操作，清除对应机甲的缓存

            if (responseData && responseData.equipped && responseData.pet_id) {
              ...
              cacheManager.clearRobotPetInfoCache(responseData.pet_id);
              console.log(`🗑️ [BagItem] 装备物品后清除机甲缓存 (pet_id: ${responseData.pet_id})`);
            }
            ...
            console.log(`✅ [BagItem] 成功使用物品: ${itemName} (ID: ${itemId})，目标: ${targetName} (${targetType})`); // 显示成功提示
        ...
        onLoad() {
          ...
          this.loadItemsData(); // 详情面板点击转发：当详情悬浮/点击后覆盖在格子上时，点击详情等价于点击对应格子，避免双击无反应
        ...
        requestWriteRandom() {
          var _this$ws$getCharacter, _this$ws;

          const cid = ((_this$ws$getCharacter = (_this$ws = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter.call(_this$ws)) || undefined; // 如果有输入框，就读取玩家输入的数量
        ...
        requestFetchBag() {
          ...
          const cid = ((_this$ws$getCharacter2 = (_this$ws2 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter2.call(_this$ws2)) || undefined;
        ...
        render() {
          ...
          const container = this.bagRoot || this.cellTemplate.parent; // 清除所有节点的选中效果（重要：在复用节点前清除，避免选中效果残留）
          ...
          const originY = base.position.y; // 注意：this.items 已经是服务器按分类和分页过滤后的数据，不需要再次过滤
          // 直接使用 this.items 作为 list

          const list = this.items; // 确保节点池里至少有 list.length 个格子
          // 第 0 个永远是模板本身
          ...
          for (let i = 0; i < list.length; i++) {
            ...
            } // 绑定点击和悬浮事件，传入当前页内的索引用于计算slot_index


            const itemIndexInCurrentPage = i; // 当前页内的索引（0-based）

            this.bindItemEvents(node, item.item_id, itemIndexInCurrentPage);
        ...
        bindItemEvents(node, itemId, itemIndexInPage) {
          const btn = node.getComponent(Button);
          if (!btn) return; // 关键修复：确保按钮是可交互的（防止场景切换后按钮被禁用）
          ...
          node.off(Node.EventType.MOUSE_LEAVE); // 点击事件 - 设置标志，防止被全局事件清除选中
        ...
        applyYellowFilter(node, apply) {
          ...
          if (apply) {
            ...
            if (!filterNode) {
              ...
              const baseSprite = node.getComponent(Sprite);
              const btn = node.getComponent(Button);
              ...
              const sprite = filterNode.addComponent(Sprite); // 优先使用Button的normalSprite（原始图标，不会因为按下而改变）

              let baseFrame = null;

              if (btn && btn.normalSprite) {
                baseFrame = btn.normalSprite;
              } else if (baseSprite && baseSprite.spriteFrame) {
                baseFrame = baseSprite.spriteFrame;
              }

              if (baseFrame) {
                sprite.spriteFrame = baseFrame;
                sprite.type = Sprite.Type.SIMPLE; // 设置50%透明的黄色 (alpha = 128, 即 255 * 0.5)

                sprite.color = new Color(255, 255, 0, 128); // 确保滤镜节点使用与物品格子完全相同的尺寸（不要使用SpriteFrame的原始尺寸）
                // 滤镜应该覆盖整个物品格子，而不是图标本身的尺寸

                uiTransform.width = baseUT.width;
                uiTransform.height = baseUT.height;
              } else {
                console.warn('⚠️ [BagItem] 无法创建黄色滤镜，节点缺少SpriteFrame');
                return;
        ...
        useItemForPlayer(itemId, itemData) {
          ...
          const cid = ((_this$ws$getCharacter3 = (_this$ws3 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter3.call(_this$ws3)) || undefined;
          ...
          this.isProcessingUseItem = true; // 优化：使用request方法，自动生成request_id并匹配响应
        ...
        confirmUseItemForPet(itemId, petId, petData) {
          ...
          const cid = ((_this$ws$getCharacter4 = (_this$ws4 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter4.call(_this$ws4)) || undefined;
        ...
        onDiscardItem(itemId) {
          ...
          const cid = ((_this$ws$getCharacter5 = (_this$ws5 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter5.call(_this$ws5)) || undefined;
      ...
      }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "nextPageBtn", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "prevPageBtn", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "pageNumberLabel", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "ui2Atlas", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "iconSet2Atlas", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "introductionPanel", [_dec18], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, "useItemPanel", [_dec19], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor19 = _applyDecoratedDescriptor(_class2.prototype, "useItemButton", [_dec20], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, "useBtn", [_dec21], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor21 = _applyDecoratedDescriptor(_class2.prototype, "discardBtn", [_dec22], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor22 = _applyDecoratedDescriptor(_class2.prototype, "robotList", [_dec23], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor23 = _applyDecoratedDescriptor(_class2.prototype, "errorTipsPanel", [_dec24], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor24 = _applyDecoratedDescriptor(_class2.prototype, "errorTipsLabel", [_dec25], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=7326e7127ffeb687e6a111275d7dc0826909ed6f.js.map