      ...
      _export("Test", Test = (_dec = ccclass('Test'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property({
        ...
        onAddExpClick() {
          ...
          try {
            ...
            const token = wsManager.getToken();
            const userId = wsManager.getUserId();
            const characterId = wsManager.getCharacterId(); // 双重验证（防止绕过）
        ...
        logExpInfo() {
          ...
          const level = (_crd && GameCommonData === void 0 ? (_reportPossibleCrUseOfGameCommonData({
            error: Error()
          }), GameCommonData) : GameCommonData).instance.level;
          const totalExp = (_crd && GameCommonData === void 0 ? (_reportPossibleCrUseOfGameCommonData({
            error: Error()
          }), GameCommonData) : GameCommonData).instance.totalExp;
          const needExp = (_crd && GameCommonData === void 0 ? (_reportPossibleCrUseOfGameCommonData({
            error: Error()
          }), GameCommonData) : GameCommonData).instance.needExpForNextLevel;
          const isMaxLevel = (_crd && GameCommonData === void 0 ? (_reportPossibleCrUseOfGameCommonData({
            error: Error()
...
//# sourceMappingURL=49008d44cb95957a380afe7747b8eff533a67b91.js.map