    ...
    execute: function () {
      ...
      _export("RobotList", RobotList = (_dec = ccclass('RobotList'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(ScrollView), _dec7 = property(Node), _dec8 = property({
        ...
        onDestroy() {
          ...
          const backBtn = (_this$backButton = this.backButton) == null ? void 0 : _this$backButton.getComponent(Button);

          if (backBtn && (_backBtn$node = backBtn.node) != null && _backBtn$node.isValid) {
            backBtn.node.off(Button.EventType.CLICK, this.onBack, this);
          }

          const confirmBtn = (_this$confirmButton = this.confirmButton) == null ? void 0 : _this$confirmButton.getComponent(Button);
        ...
        loadBattleTeamThenPets(useCacheIfAvailable = false) {
          ...
          const hasFullCache = useCacheIfAvailable && (cachedData == null ? void 0 : cachedData.pets) && Array.isArray(cachedData.pets) && cachedData.pets.length > 0 && cachedData.battle_team && Array.isArray(cachedData.battle_team);
        ...
        onPetsResponse(data) {
          ...
          const pagination = (_data$pagination = data.pagination) != null ? _data$pagination : (_data$data3 = data.data) == null ? void 0 : _data$data3.pagination;
        ...
        sortByBattleTeam() {
          ...
          for (const p of this.currentPets) {
            ...
            const id = this.normPetId(String((_ref2 = (_ref3 = (_p$pet_id = p.pet_id) != null ? _p$pet_id : p._id) != null ? _ref3 : p.id) != null ? _ref2 : ''));
        ...
        fillRow(node, pet, _index) {
          ...
          const id = String((_ref4 = (_ref5 = (_pet$pet_id = pet.pet_id) != null ? _pet$pet_id : pet._id) != null ? _ref5 : pet.id) != null ? _ref4 : '');
          const form = Number((_ref6 = (_pet$Form = pet.Form) != null ? _pet$Form : pet.Fo) != null ? _ref6 : 0);
        ...
        updateRowBattleFilter(node, pet) {
          ...
          const id = this.normPetId(String((_ref7 = (_ref8 = (_pet$pet_id2 = pet.pet_id) != null ? _pet$pet_id2 : pet._id) != null ? _ref8 : pet.id) != null ? _ref7 : ''));
        ...
        bindSetAndActions(node, pet, index) {
          ...
          const petId = String((_ref9 = (_ref10 = (_pet$pet_id3 = pet.pet_id) != null ? _pet$pet_id3 : pet._id) != null ? _ref10 : pet.id) != null ? _ref9 : ''); // 将 pet 数据绑定到节点，方便后续使用
        ...
        onDeploy(petId, row, panel) {
          ...
          if (nodePet) {
            ...
            const correctId = String((_ref11 = (_ref12 = (_nodePet$pet_id = nodePet.pet_id) != null ? _nodePet$pet_id : nodePet._id) != null ? _ref12 : nodePet.id) != null ? _ref11 : '');
        ...
        submitBattleTeam(team) {
          ...
          for (const id of team) {
            ...
            const pet = this.currentPets.find(p => {
              ...
              const pid = this.normPetId(String((_ref13 = (_ref14 = (_p$pet_id2 = p.pet_id) != null ? _p$pet_id2 : p._id) != null ? _ref14 : p.id) != null ? _ref13 : ''));
          ...
          const validPets = normalizedTeam.filter(pid => {
            ...
            const pet = this.currentPets.find(p => {
              ...
              return this.normPetId(String((_ref15 = (_ref16 = (_p$pet_id3 = p.pet_id) != null ? _p$pet_id3 : p._id) != null ? _ref16 : p.id) != null ? _ref15 : '')) === pn;
            });
          ...
          console.log('[RobotList] 当前机甲列表 petIds:', this.currentPets.map(p => {
            ...
            return String((_ref17 = (_ref18 = (_p$pet_id4 = p.pet_id) != null ? _p$pet_id4 : p._id) != null ? _ref18 : p.id) != null ? _ref17 : '');
          }));
          this.ws.request((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            error: Error()
          }), GameConfig) : GameConfig).MESSAGE_TYPES.SET_BATTLE_TEAM, {
        ...
        onConfirm() {
          ...
          const petId = String((_ref19 = (_ref20 = (_this$selectedPet$pet = this.selectedPet.pet_id) != null ? _this$selectedPet$pet : this.selectedPet._id) != null ? _ref20 : this.selectedPet.id) != null ? _ref19 : '');
