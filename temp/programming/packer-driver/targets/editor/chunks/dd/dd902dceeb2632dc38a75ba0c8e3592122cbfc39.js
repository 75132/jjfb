    ...
    execute: function () {
      ...
      _export("GameCommonData", GameCommonData = (_dec = ccclass('GameCommonData'), _dec2 = property({
        ...
        constructor(...args) {
          ...
          this.onPlayerInfo = data => {
            ...
            if (!responseData || !responseData.success) {
              ...
              const code = Number(((_responseData = responseData) == null ? void 0 : _responseData.code) || 0); // 角色被删/会话失效时，直接强制退出到登录，避免停留在空壳 Game 场景。
            ...
            const roleName = String(responseData.role_name || ''); // 更新数据
          ...
          this.onAddExpResponse = data => {
            ...
            const levelUpCount = data.level_up_count || 0; // 更新数据
        ...
        onLoad() {
          ...
          const wsNode = this.wsManager.node;
        ...
        triggerLoadingOnDataMissing(reason) {
          ...
          const gameControl = (_this$node$scene = this.node.scene) == null || (_this$node$scene = _this$node$scene.getChildByName('Game')) == null ? void 0 : _this$node$scene.getComponent('GameControl');
        ...
        refreshData(dataType = 'all', callback) {
          switch (dataType) {
            case 'player':
            case 'all':
        ...
        requestPlayerInfo() {
          ...
          const cid = ((_this$wsManager$getCh = (_this$wsManager = this.wsManager).getCharacterId) == null ? void 0 : _this$wsManager$getCh.call(_this$wsManager)) || undefined;
...
//# sourceMappingURL=dd902dceeb2632dc38a75ba0c8e3592122cbfc39.js.map