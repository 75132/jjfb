    ...
    execute: function () {
      ...
      _export("AnnouncementPanel", AnnouncementPanel = (_dec = ccclass('AnnouncementPanel'), _dec2 = property({
        ...
        onChatMessage(data) {
          ...
          const text = String(data.text || ''); // 统一格式：与大窗口一致，使用 [世]名：消息 格式
        ...
        onDestroy() {
          ...
          const wsNode = (_this$wsManager2 = this.wsManager) == null ? void 0 : _this$wsManager2.node;
...
//# sourceMappingURL=005ded2ea42086fbeebc229375b5bc1830b7a820.js.map