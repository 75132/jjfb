      ...
      _export("CentralMenu", CentralMenu = (_dec = ccclass('CentralMenu'), _dec2 = property({
        ...
        bindButtons() {
          ...
          var _loop = function _loop(i) {
            var btn = buttons[i];
            var panel = panels[i];
            if (!btn || !panel) return 0; // continue
            // 如果按钮由 GameMenu 管理，则不在这里绑定

            if (_this.isManagedByGameMenu(btn.node)) return 0; // continue
...
//# sourceMappingURL=2ff81ffd44e873b353ca3d8b07b107c69cb6719b.js.map