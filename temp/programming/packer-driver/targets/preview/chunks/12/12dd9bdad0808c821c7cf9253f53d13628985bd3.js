    ...
    execute: function () {
      ...
      _export("BattleScene", BattleScene = (_dec = ccclass('BattleScene'), _dec2 = property({
        ...
        checkAndStartBattle() {
          ...
          var characterId = (_this$ws$getCharacter5 = (_this$ws5 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter5.call(_this$ws5);
        ...
        finishBattle(winner, reason) {
          ...
          try {
            ...
            var cid = (_this$ws$getCharacter10 = (_this$ws10 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter10.call(_this$ws10);
            ...
            if (cid) {
              ...
              var uid = (_this$ws$getUserId = (_this$ws11 = this.ws).getUserId) == null ? void 0 : _this$ws$getUserId.call(_this$ws11);
        ...
        refreshPlayerShowFromServer() {
          ...
          var characterId = (_this$ws$getCharacter11 = (_this$ws12 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter11.call(_this$ws12);
          ...
          var userId = (_this$ws$getUserId2 = (_this$ws13 = this.ws).getUserId) == null ? void 0 : _this$ws$getUserId2.call(_this$ws13);
        ...
        refreshEnemyShowFromCharacterId(characterId) {
          ...
          var userId = (_this$ws$getUserId3 = (_this$ws14 = this.ws).getUserId) == null ? void 0 : _this$ws$getUserId3.call(_this$ws14);
