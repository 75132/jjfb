      ...
      _export("CharacterProfile", CharacterProfile = (_dec = ccclass('CharacterProfile'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Label), _dec10 = property(Node), _dec11 = property(Sprite), _dec12 = property([SpriteFrame]), _dec13 = property(Button), _dec14 = property(Label), _dec15 = property(Node), _dec16 = property(Button), _dec17 = property(Button), _dec18 = property(Button), _dec(_class = (_class2 = class CharacterProfile extends Component {
        constructor(...args) {
          ...
          this.onPlayerInfo = data => {
            ...
            let responseData = data; // 如果是标准响应格式（使用 send_success_response），数据在 data.data 中
            ...
            if (data && data.success && data.data && typeof data.data === 'object') {
              ...
              responseData = { ...data,
                // 先复制根级别字段（包括 type, success, code, timestamp, request_id）
            ...
            const name = (_responseData$role_na = responseData.role_name) != null ? _responseData$role_na : '';
            const level = Number((_responseData$level = responseData.level) != null ? _responseData$level : 0);
            const fid = (_responseData$friend_2 = responseData.friend_id) != null ? _responseData$friend_2 : '';
            const cls = Number((_responseData$class = responseData.class) != null ? _responseData$class : 0);
            const gold = Number((_responseData$gold = responseData.gold) != null ? _responseData$gold : 0);
            const energyBlocks = (_crd && getEnergyBlocksFromPayload === void 0 ? (_reportPossibleCrUseOfgetEnergyBlocksFromPayload({
              error: Error()
            }), getEnergyBlocksFromPayload) : getEnergyBlocksFromPayload)(responseData);
            const robotCount = Number((_responseData$robotco = responseData.robotcount) != null ? _responseData$robotco : 0);
            const spriteIndex = Number((_responseData$Sprite = responseData.Sprite) != null ? _responseData$Sprite : 0);
            const cur = Number((_responseData$current = responseData.current_level_exp) != null ? _responseData$current : 0);
            const need = Number((_responseData$next_le = responseData.next_level_need_exp) != null ? _responseData$next_le : 0); // ✅ 提取其他字段

            const alliance = (_responseData$allianc = responseData.alliance) != null ? _responseData$allianc : '';
            const record = (_responseData$record = responseData.record) != null ? _responseData$record : '';
            const rank = (_responseData$rank = responseData.rank) != null ? _responseData$rank : '';
        ...
        onAddFriend() {
          ...
          const targetCharacterId = (_this$currentConfig = this.currentConfig) == null ? void 0 : _this$currentConfig.characterId;
...
//# sourceMappingURL=ff4d59c9aadad2cdc243ad5289123156baa4cad6.js.map