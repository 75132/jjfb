    ...
    execute: function () {
      ...
      _export("StoryUIAutoBuilder", StoryUIAutoBuilder = (_dec = ccclass('StoryUIAutoBuilder'), _dec2 = executeInEditMode(true), _dec3 = property({
        ...
        layoutStoryLayer(storyLayer) {
          ...
          const layout = (_options$getComponent = options.getComponent(Layout)) != null ? _options$getComponent : options.addComponent(Layout);
        ...
        ensureUITransform(node, width, height, ax, ay) {
          ...
          const ut = (_node$getComponent = node.getComponent(UITransform)) != null ? _node$getComponent : node.addComponent(UITransform);
        ...
        ensureLabel(node, fontSize, hAlign, vAlign, text) {
          ...
          const label = (_node$getComponent2 = node.getComponent(Label)) != null ? _node$getComponent2 : node.addComponent(Label);
...
//# sourceMappingURL=b99fe1921a8826017ee7313f3855d49364818106.js.map