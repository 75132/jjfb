    ...
    execute: function () {
      ...
      _export("StoryMapModel", StoryMapModel = class StoryMapModel {
        constructor(jsonAsset) {
          ...
          const raw = (_jsonAsset$json = jsonAsset == null ? void 0 : jsonAsset.json) != null ? _jsonAsset$json : {};
          this.raw = raw;
          ...
          const dc = (_raw$client$dialogueS = (_raw$client = raw.client) == null ? void 0 : _raw$client.dialogueScripts) != null ? _raw$client$dialogueS : {};
          Object.keys(dc).forEach(k => this.dialogueScripts.set(k, dc[k]));
          const cc = (_raw$client$choiceScr = (_raw$client2 = raw.client) == null ? void 0 : _raw$client2.choiceScripts) != null ? _raw$client$choiceScr : {};
        ...
        getFirstEligibleEvent(npcUid, state) {
          ...
          const npc = this.npcsByUid.get(npcUid);
          if (!(npc != null && (_npc$events = npc.events) != null && _npc$events.length)) return null;
          const sorted = [...npc.events].sort((a, b) => a.order - b.order);
