System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfCharacterCreatePanel(extras) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("CharacterSelect", CharacterSelect = (_dec = ccclass('CharacterSelect'), _dec2 = property([Node]), _dec3 = property(SpriteFrame), _dec4 = property(SpriteFrame), _dec5 = property([SpriteFrame]), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Label), _dec14 = property(Label), _dec15 = property(Node), _dec16 = property([Button]), _dec17 = property([Button]), _dec18 = property([Button]), _dec19 = property(Node), _dec20 = property(Button), _dec21 = property(Button), _dec22 = property({
        ...
        type: Label,
        tooltip: '首次进入选角的操作提示（可选绑定，约5秒后自动隐藏）'
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "slotHintLabel", _descriptor22, this);
          ...
          this.onAllCharactersResponse = data => {
            ...
            if (resp.success && resp.characters && typeof resp.characters === 'object') {
              const fp = (_crd && WebSocketManager === void 0 ? (_reportPossibleCrUseOfWebSocketManager({
                error: Error()
          ...
          this.onSelectCharacterResponse = data => {
            ...
            if (success && this.pendingStartGameSlot >= 0) {
              ...
              const slotData = this.slotRoleData[slotIndex]; // 清除超时定时器
              ...
              if (this.gameScenePreloaded) {
                ...
                if (!this.preloadingForJump) {
                  ...
                  director.preloadScene((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
                    error: Error()
        ...
        formatPositionForLabel(position) {
          ...
          if (typeof p === 'object') {
            ...
            const x = (_p$x = p.x) != null ? _p$x : p.X;
            const y = (_p$y = p.y) != null ? _p$y : p.Y;
        ...
        requestSlotData(idx) {
          ...
          const requestId = `char_info_${Date.now()}_${idx}`; // 提前设置 requestId 映射，避免回调中访问时出错
        ...
        showSlotButtons(idx) {
          ...
          const hasCharacter = data.role_name && data.role_name !== 0 && data.role_name !== '0' && data.role_name !== '' && data.Sprite && data.Sprite !== 0 && data.Sprite !== '0';
        ...
        onCharacterInfo(data) {
          ...
          let slotIndex = this.selectedIndex; // 优先使用服务端返回的 slot_index，避免在重试/重复响应时退回 selectedIndex 导致错位覆盖
          ...
          const requestId = (_data = data) == null ? void 0 : _data.request_id;
          ...
          this.slotRoleData[slotIndex] = { ...existingData,
            // 保留原有数据
            ...data,
            // 用新数据覆盖
          ...
          const mergedData = this.slotRoleData[slotIndex]; // 设置精灵图片（修复：基于合并后的 mergedData 判断，避免部分字段推送导致误判为空槽位）
          ...
          if (characterSpriteNode) {
            ...
            if (characterSprite) {
              ...
              const isEmptySlot = !mergedData.role_name || mergedData.role_name === 0 || mergedData.role_name === '0' || mergedData.role_name === '' || !mergedData.Sprite || mergedData.Sprite === 0 || mergedData.Sprite === '0';
        ...
        onCreateClick(idx) {
          if (this.createPanel) {
            ...
            const characterPanel = this.createPanel.getComponent(_crd && CharacterCreatePanel === void 0 ? (_reportPossibleCrUseOfCharacterCreatePanel({
              error: Error()
            }), CharacterCreatePanel) : CharacterCreatePanel);
      ...
      }), _descriptor22 = _applyDecoratedDescriptor(_class2.prototype, "slotHintLabel", [_dec23], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=aef837c5a5634d0f3805851bcb9557bd55243201.js.map