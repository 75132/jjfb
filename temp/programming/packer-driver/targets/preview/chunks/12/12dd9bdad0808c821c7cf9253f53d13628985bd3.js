    ...
    execute: function () {
      ...
      _export("BattleScene", BattleScene = (_dec = ccclass('BattleScene'), _dec2 = property({
        ...
        _unbindNetworkReconnect() {
          ...
          var node = (_this$ws7 = this.ws) == null ? void 0 : _this$ws7.node;
        ...
        sendBattleRoomAction(action) {
          ...
          var characterId = (_this$ws$getCharacter10 = (_this$ws12 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter10.call(_this$ws12);
        ...
        finishBattle(winner, reason) {
          ...
          try {
            ...
            var cid = (_this$ws$getCharacter11 = (_this$ws13 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter11.call(_this$ws13);
            ...
            if (cid) {
              ...
              var uid = (_this$ws$getUserId = (_this$ws14 = this.ws).getUserId) == null ? void 0 : _this$ws$getUserId.call(_this$ws14);
        ...
        refreshPlayerShowFromServer() {
          ...
          var characterId = (_this$ws$getCharacter12 = (_this$ws15 = this.ws).getCharacterId) == null ? void 0 : _this$ws$getCharacter12.call(_this$ws15);
          if (!characterId) return;
          ...
          var userId = (_this$ws$getUserId2 = (_this$ws16 = this.ws).getUserId) == null ? void 0 : _this$ws$getUserId2.call(_this$ws16);
        ...
        refreshEnemyShowFromCharacterId(characterId) {
          ...
          var userId = (_this$ws$getUserId3 = (_this$ws17 = this.ws).getUserId) == null ? void 0 : _this$ws$getUserId3.call(_this$ws17);
