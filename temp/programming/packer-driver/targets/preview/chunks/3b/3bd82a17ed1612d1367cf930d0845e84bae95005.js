    ...
    execute: function () {
      ...
      _export("StoryDialoguePlayer", StoryDialoguePlayer = (_dec = ccclass('StoryDialoguePlayer'), _dec(_class = (_class2 = class StoryDialoguePlayer extends Component {
        ...
        get isBlocking() {
          ...
          var d = (_this$_refs$dialogueP = (_this$_refs3 = this._refs) == null || (_this$_refs3 = _this$_refs3.dialoguePanel) == null ? void 0 : _this$_refs3.active) != null ? _this$_refs$dialogueP : false;
          var c = (_this$_refs$choiceMod = (_this$_refs4 = this._refs) == null || (_this$_refs4 = _this$_refs4.choiceModal) == null ? void 0 : _this$_refs4.active) != null ? _this$_refs$choiceMod : false;
          return d || c;
        }
        ...
        startChoice(choice, onPick, onClose) {
          ...
          var _loop = function _loop() {
            ...
            var fn = () => {
              _this._refs.choiceModal.active = false;

              _this._clearChoiceHandlers();

              onPick == null || onPick(opt);
              if (opt.npcReply) _this.showToast(opt.npcReply, 3500);
              if (opt.systemTip) _this.showToast(opt.systemTip, 3500);
              onClose == null || onClose();
            };

            btnNode.on(Node.EventType.TOUCH_END, fn, _this);

            _this._choiceHandlers.push(() => btnNode.off(Node.EventType.TOUCH_END, fn, _this));
          },
              _ret;
        ...
        _advanceLine() {
          ...
          var willClose = !(this._lineIndex < linesLen - 1);
          (_crd && storyLog === void 0 ? (_reportPossibleCrUseOfstoryLog({
            error: Error()
        ...
        _clearChoiceHandlers() {
          ...
          this._choiceHandlers = [];
          var btnComp = (_this$_refs13 = this._refs) == null || (_this$_refs13 = _this$_refs13.nextButton) == null ? void 0 : _this$_refs13.getComponent(Button);
