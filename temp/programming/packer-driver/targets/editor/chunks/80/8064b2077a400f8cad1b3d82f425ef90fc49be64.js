  ...
  function evaluateStoryRequirements(reqs, progress, isEventIdComplete) {
    ...
    for (const raw of reqs) {
      ...
      if (rtype === 'event_done' || rtype === 'event_completed') {
        ...
        if (progress.mainlineStep < need) return false;
